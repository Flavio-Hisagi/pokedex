/*
quando clicar no pkémon da listagem  temos que esconder o cartão do pokémon aberto e mostrar o cartão correspondente ao que foi selecionado na listagem
...
listaSelecaoPokemons.forEach(pokemon => {
    ...
    pokemon.addEventListener('click', () => {
        ...
        const idSoCartaoPokemonParaAbrir = 'cartao-' + idPokemonSelecionado
        const cartaoPokemonParaAbrir = document.getElementById(idSoCartaoPokemonParaAbrir)
